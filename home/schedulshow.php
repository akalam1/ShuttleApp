...
<head>
	...
	<ul class="dropdown-menu">
		<li><a class="dropdown-item" href="routename.php"></a></li>
		<li><a class="dropdown-item" href="routemap.html"> </a></li>
	</ul>
	</li>
...
<body>
	...
	?>
		<table class="table table-bordered,hover" bgcolor="orange" style="margin-left:auto; margin-right:auto; text-align:center;" border="6" width :"80% ">
      <thead>
<tr>
<th>BusLocation</th>
<th>LotNumber</th>
	...
	<?php
		while ($result = mysqli_fetch_array($data)) {
			...
			<tr>
				...
				<td><a href='update.php?BusLocation=$result[BusLocation] & LotNumber=$result[LotNumber] & DepartureTime=$result[DepartureTime] & ArrivalTime=$result[ArrivalTime]'>  </a></td>
				<td><a href='delete.php?BusLocation=$result[BusLocation] '> </a></td>
			</tr>
		";
		}
	} else {
