...
<a href="route_details.php" , font size="10" >Add a New Routes  </font> </a>
<h2> All Routes</h2>
<?php
	...
	while ($result = mysqli_fetch_array($data)) {
		echo "
			<tr>
				...
				<td><a href='update_routes.php?routeId=$result[routeId] & routeName=$result[routeName] '> Edit </a></td>
				<td><a href='delete_route.php?routeId=$result[routeId] '>delete </a></td>
			</tr>
		";
	}
}
