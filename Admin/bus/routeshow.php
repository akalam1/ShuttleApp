	...
	while ($result = mysqli_fetch_array($data)) {
		echo "
            ...
            <td>".$result['busName']."</td>
				...
				<td><a href='update_bus.php?busID=$result[busID] & busNo=$result[busNo] & busName=$result[busName]'>  </a></td>
				<td><a href='delete_bus.php?busID=$result[busID] '> </a></td>
			</tr>
		";
	}
}
