	...
	<?php
        while ($result = mysqli_fetch_array($data)) {
			...
			<tr>
				...
				<td><a href='update.php?BusLocation=$result[BusLocation] & LotNumber=$result[LotNumber] & DepartureTime=$result[DepartureTime] & ArrivalTime=$result[ArrivalTime]'> Update  </a></td>
