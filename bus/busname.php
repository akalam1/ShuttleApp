         ...
         <ul class="navbar-nav me-auto mb-2 mb-lg-0">
           <li class="nav-item">
             ...
             <ul class="dropdown-menu">
               <li><a class="dropdown-item" href="busNo.php"></a></li>       
...
<div class="container">
  <center><h2>Bus Name</h2></center>
           
  <table class="table-hover"  style="margin-left:auto; margin-right:auto;  text-align:center; "  border="7" width :"80% ">
      <thead>
